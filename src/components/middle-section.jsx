...
return (
    ...
    <div className="lg-w:[100%] lg-h:[130%]"> 
        ...
        Fusionara is where worlds collide: <br />
        an epic, story-driven universe that  brings <br />
         together characters from 
        popular NFT <br /> 
        and mainstream anime IPs in an <br /> expanding ecosystem 
        that realizes the <br /> potential of web3. 
